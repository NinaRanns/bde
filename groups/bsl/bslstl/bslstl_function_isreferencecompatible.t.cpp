...
// yields 'true_type' if it is the same as 'TO_TYPE'; else it yields
...
// behaviour in the presence of a user provided specialization.
//
// ----------------------------------------------------------------------------
//
// PUBLIC CLASS DATA
...
int main(int argc, char *argv[])
{
    ...
    switch (test) {
      ...
      case 2: {
        ...
        //: 5 To simplify testing the cross-product of types and
        //:   const-qualifiers, encapsulate steps 1-3 and 4 into a function,
        //:   'testIsReferenceCompatible', which is instantiated with a 'T', a
        //:   'U', and an expected result and which tests each combination of
        //:    const qualifiers.
        //
        // Testing:
